...
if (isset($_POST['publish'])) {
    ...
    if ($select_image->rowCount() > 0 and $image != '') {
        ...
        $insert_product = $conn->prepare("INSERT INTO `products` (id, seller_id, name, image, product_detail, status) VALUES(?,?,?,?,?,?)");
        $insert_product->execute([$id, $seller_id, $name, $image, $description, $status]);
        $succes_msg[] = 'Producto insertado correctamente';
    }
}
...
if (isset($_POST['draft'])) {
    ...
    if ($select_image->rowCount() > 0 and $image != '') {
        ...
        $insert_product = $conn->prepare("INSERT INTO `products` (id, seller_id, name, image, product_detail, status) VALUES(?,?,?,?,?,?)");
        $insert_product->execute([$id, $seller_id, $name, $image, $description, $status]);
        $succes_msg[] = 'Producto guardado en borrador con exito!';
    }
}
...
<head>
    ...
    <title>Admin Agregar Productos page</title>
            ...
            <div class="form-container">
                <form action="" method="post" enctype="multipart/form-data" class="register">
                    <div class="input-field">
                        ...
                        <input type="text" name="name" maxlength="100" placeholder="Agrega el nombre del producto" required class="box">
                    </div>
                    <!--<div class="input-field">
                    ...
                    <div class="input-field">
                        <p>Detalles del Producto<span>*</span></p>
                        <textarea name="description" required maxlength="1000" placeholder="Agrega descripcion del producto" class="box"></textarea>
                    </div>
                    <!--<div class="input-field">
